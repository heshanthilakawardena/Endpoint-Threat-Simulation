# Endpoint Threat Simulation & FIM Engine 

> **STRICT ETHICAL DISCLAIMER:** > This project was developed entirely for educational purposes, academic research, and personal portfolio demonstration. The scripts provided here are designed to simulate endpoint attacks and validate defensive monitoring logic on authorized, local machines *only*. **Do not** deploy or use any part of this code on systems you do not own or do not have explicit, written permission to audit. 
